  ...
  return (
    <div className="relative w-full h-full flex flex-col justify-center">
      ...
      <div className="z-10 animate-[fadeIn_1s_ease-out]">
        ...
        <h1 className="text-7xl md:text-[10rem] font-black tracking-[-0.05em] leading-[0.8] dark:text-white text-indigo-950 mb-8 font-display">
          SMRITI
        </h1>
        ...
        <div className="max-w-xl space-y-8">
          <p className="text-base md:text-lg font-medium dark:text-white text-indigo-950/70 leading-relaxed font-display min-h-[120px]">
            I am Smriti Paudel, a <span className="dark:text-yellow-400 text-indigo-950 font-black border-r-4 border-black dark:border-yellow-400 pr-2 animate-pulse">{typedText}</span>.
            {roleIndex === 0 ? (
          ...
          <div className="pt-2">
            <p className="text-sm font-bold dark:text-white/50 text-indigo-950/50 mb-3 font-display">Welcome to my portfolio.</p>
